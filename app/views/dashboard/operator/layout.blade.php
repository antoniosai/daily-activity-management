            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li>
                            <a href="{{ action('OperatorController@getProfile') }}"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                        <li>
                            <a href="{{ action('LogbookController@getShowLogbook') }}"><i class="fa fa-fw fa-tasks"></i> Logbook</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-edit"></i> Report</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-users"></i> Bantuan</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
